...
def generate_unique_filename(module_name):
    try:
        # Haal het publieke IP-adres op
    ...
    return f"{DATA_DIR}/{module_name}_results_{timestamp}_{public_ip}.json"


# Upload results to repo
def upload_results(module, results):
    file_path = generate_unique_filename(module)
